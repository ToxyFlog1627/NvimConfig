...
-- Telescope - finder (:help telescope, :help telescope.setup())
...
-- TODO: define global helper functions such as nmap instead of usnig vim.keymap(n, ...)
